...
TEST_IMAGE_PATHS = glob.glob('/home/oo/Desktop/object/test_images/*.jpg')
...
while True:
    try:
        ...
        if is_camera_online:
            ...
            scipy.misc.imsave('live_result.png', image_np)

            files = {'file': open('live_result.png', 'rb')}
            requests.post(URL, files=files)
        time.sleep(0.024)
        os.remove("live.png")
        os.remove("live_result.png")
...
'''
  ...
  plt.imshow(image_np)
  save_path = image_path.split("/", -1)[-1]
  print(save_path)
  scipy.misc.imsave('/home/oo/Desktop/object/result_images/' + save_path, image_np)
'''
